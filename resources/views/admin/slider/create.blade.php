...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active">Registro de sliders</li>
</ol>
                                   ...
                                   <div class="card-body">
                                       <div class="row">
                                           <div class="col-lg-12 form-group">
                                               <input type="text" class="form-control {{ $errors->has('titulo') ? ' is-invalid' : '' }}" placeholder="Titulo de el slider" name="titulo">
