...
@section('contenido')
<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="{{ route('index.menu') }}">Listado de menus</a></li>
    <li class="breadcrumb-item active">Actualizar menu</li>
</ol>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 form-group">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control {{ $errors->has('enlace') ? ' is-invalid' : '' }}" placeholder="Enlace del menu" name="enlace" id="input_enlace" value="{{ $item_menu->enlace }}">
                                                    ...
                                                    <div class="col-lg-5 form-group">
                                                        <input type="text" class="form-control {{ $errors->has('titulo') ? ' is-invalid' : '' }}" placeholder="titulo del menu" name="titulo" value="{{ $item_menu->titulo }}">
                                                    </div>
                                                    <div class="col-lg-5 form-group">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control {{ $errors->has('icono') ? ' is-invalid' : '' }}" placeholder="Icono del menu" name="icono" id="input_icono" value="{{ $item_menu->icono }}">
                                                            <div class="input-group-addon">
