                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-12 form-group">
                                            <a type="button" class="btn btn-success" data-toggle="modal" data-target="#addphoto">Registrar imagen</a>
                                            <!-- Modal -->
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalCenterTitle">Cargar foto</h5>
