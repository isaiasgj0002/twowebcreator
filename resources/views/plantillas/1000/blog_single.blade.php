...
<section class="breadcrumbs-custom" style="margin-top: 150px !important;">
    <div class="parallax-container" data-parallax-img="{{ asset('general/'.$general->fondo_principal) }}">
      <div class="breadcrumbs-custom-body parallax-content context-dark">
        <div class="container">
          <h1 class="breadcrumbs-custom-title" style="font-family: {{ $general->fuente }} !important;">Blog Post</h1>
        </div>
      </div>
    </div>
    <div class="breadcrumbs-custom-footer">
      <div class="container">
        <ul class="breadcrumbs-custom-path">
          <li class="active" style="font-family: {{ $general->fuente }} !important;">Blog Post</li>
        </ul>
      </div>
    </div>
  </section>
            ...
            <div class="row row-50 row-md-60 row-lg-80">
              <div class="col-12">
                <article class="post post-modern box-xxl">
                  ...
                  <h3 class="post-modern-title" style="font-family: {{ $general->fuente }} !important;">{{ $blog->titulo }}</h3>
                  <div class="post-modern-figure"><img src="{{asset('blog/'.$blog->imagen)}}" alt="" width="800" height="394"/>
                  </div>
                  <p class="post-modern-text" style="font-family: {{ $general->fuente }} !important;"><?php echo $blog->contenido ?></p>
                </article>
                <!-- Quote Classic-->
              </div>
            </div>
