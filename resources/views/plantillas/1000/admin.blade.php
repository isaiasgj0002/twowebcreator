    ...
    <div class="page">
              ...
              <div class="rd-navbar-aside">
                <div class="rd-navbar-collapse">
                  <ul class="contacts-classic">
                    <li><span class="contacts-classic-title" style="color: {{ $menu->color }} !important">Telefono:</span> <a href="tel:#" style="color: {{ $menu->color }} !important">{{ $footer->telefono }}</a>
                    </li>
                    <li><a href="mailto:#" style="color: {{ $menu->color }} !important">{{ $footer->correo }}</a></li>
                  </ul>
                </div>
                <!-- RD Navbar Panel-->
      ...
      <footer class="section footer-modern footer-modern-2">
            ...
            <div class="row row-40 row-md-50 justify-content-xl-between">
              <div class="col-md-10 col-lg-3 col-xl-4 wow fadeInRight">
                <div class="inset-xl-right-70">
                  <h5 class="footer-modern-title" style="font-family: {{ $general->fuente }} !important;">Galeria</h5>
                  <div class="row row-10 gutters-10" data-lightgallery="group">
                    @foreach ($galeria_footer as $item)
                    <div class="col-4 col-sm-2 col-lg-4">
                        <a class="thumbnail-minimal" href="{{ asset('galeria/'.$item->imagen) }}" data-lightgallery="item"><img src="{{ asset('galeria/'.$item->imagen) }}" alt="" width="93" height="93"/></a>
                      </div>
                    @endforeach
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-md-7 col-lg-5 wow fadeInRight" data-wow-delay=".1s">
                <h5 class="footer-modern-title" style="font-family: {{ $general->fuente }} !important;">Enlaces</h5>
                <ul class="footer-modern-list footer-modern-list-2 d-sm-inline-block d-md-block">
                  @foreach ($items_menu as $item)
                    <li style="color: {{ $menu->color }} !important"><a style="font-family: {{ $general->fuente }} !important;" class="rd-nav-link" href="{{ $item->enlace }}"><?php echo $item->icono?>{{ $item->titulo }}</a>
                    </li>
                    @endforeach
                </ul>
              </div>
              <div class="col-sm-6 col-md-5 col-lg-4 col-xl-3 wow fadeInRight" data-wow-delay=".2s">
                <h5 class="footer-modern-title" style="font-family: {{ $general->fuente }} !important;">Contactanos</h5>
                <ul class="contacts-creative">
                  <li>
                    <div class="unit unit-spacing-sm flex-column flex-md-row">
                      <div class="unit-left"><span class="icon mdi mdi-map-marker"></span></div>
                      <div class="unit-body"><a style="font-family: {{ $general->fuente }} !important;"><?php echo $footer->direccion ?></a></div>
                    </div>
                  </li>
                  <li>
                    <div class="unit unit-spacing-sm flex-column flex-md-row">
                      <div class="unit-left"><span class="icon mdi mdi-phone"></span></div>
                      <div class="unit-body"><a style="font-family: {{ $general->fuente }} !important;">{{ $footer->telefono }}</a></div>
                    </div>
                  </li>
                  <li>
                    <div class="unit unit-spacing-sm flex-column flex-md-row">
                      <div class="unit-left"><span class="icon mdi mdi-email-outline"></span></div>
                      <div class="unit-body"><a style="font-family: {{ $general->fuente }} !important;">{{ $footer->correo }}</a></div>
                    </div>
                  </li>
                </ul>
              </div>
        ...
        <div class="footer-modern-panel text-center">
          <div class="container">
            <p class="rights" style="font-family: {{ $general->fuente }} !important;">{{ $footer->cr }}</p>
          </div>
        </div>
      </footer>
    </div>
