    ...
    <div class="container">
      <div class="row row-30 text-md-left justify-content-sm-center">
        ...
        <div class="col-md-6 col-lg-4">
            <article class="post-news post-news-wide"><a href="http://127.0.0.1:8000/{{ $dominio }}/contenido/pagina/blog/{{ $item->slug }}"><img class="img-responsive" src="{{asset('blog/'.$item->imagen)}}" width="700" height="455" alt=""></a>
