...
class ConfigFooterController extends Controller
{
    ...
    function index(){
        ...
        $footer=DB::table('config_footer')->where('idpagina','=',$current_page)->first();
    ...
    function update_footer(Request $request,$id){
        $validate = $this->validate($request, [
            ...
            'telefono'=>'required|max:12|min:8',
        ...
        $footer->update();
        Session::flash('succes', 'Se actualizo su configuracion del footer');
